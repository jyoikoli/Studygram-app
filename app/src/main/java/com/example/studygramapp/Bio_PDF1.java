...
public class Bio_PDF1 extends AppCompatActivity {
    String link="",productList="",product="";
    PDFView pdfView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bio_pdf1);
        ...
        if (isConnected()) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(Bio_PDF1.this);
            builder.setTitle("NoInternet Connection Alert")
                    ...
                    .setNegativeButton("No", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(Bio_PDF1.this,"Go Back TO HomePage!",Toast.LENGTH_SHORT).show();
                        }
                    });
            //Creating dialog box
        ...
        new Bio_PDF1.RetrievePDFStream().execute(link);
    }
    ...
    class RetrievePDFStream extends AsyncTask<String, Void, InputStream> {
        ...
        {
            progressDialog = new ProgressDialog(Bio_PDF1.this);
