...
public class EngProductAdapter1 extends RecyclerView.Adapter<EngProductAdapter1.ProductViewHolder> {
    ...
    // Constructor
    public EngProductAdapter1(Context context, List<Product1> productList, OnItemClickListener listener) {
