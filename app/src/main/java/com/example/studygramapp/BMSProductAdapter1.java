...
public class BMSProductAdapter1 extends RecyclerView.Adapter<BMSProductAdapter1.ProductViewHolder> {
    ...
    // Constructor
    public BMSProductAdapter1(Context context, List<Product1> productList, OnItemClickListener listener) {
