...
public class BMS_PDF1 extends AppCompatActivity {
    String link="",productList="",product="";
    PDFView pdfView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bms_pdf1);
        ...
        if (isConnected()) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(BMS_PDF1.this);
            builder.setTitle("NoInternet Connection Alert")
                    ...
                    .setNegativeButton("No", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(BMS_PDF1.this,"Go Back TO HomePage!",Toast.LENGTH_SHORT).show();
                        }
                    });
            //Creating dialog box
        ...
        new BMS_PDF1.RetrievePDFStream().execute(link);
    }
    ...
    class RetrievePDFStream extends AsyncTask<String, Void, InputStream> {
        ...
        {
            progressDialog = new ProgressDialog(BMS_PDF1.this);
