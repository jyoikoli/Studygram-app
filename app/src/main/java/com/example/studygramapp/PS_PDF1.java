...
public class PS_PDF1 extends AppCompatActivity {
    String link="",productList="",product="";
    PDFView pdfView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ps_pdf1);
        ...
        if (isConnected()) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(PS_PDF1.this);
            builder.setTitle("NoInternet Connection Alert")
                    ...
                    .setNegativeButton("No", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(PS_PDF1.this,"Go Back TO HomePage!",Toast.LENGTH_SHORT).show();
                        }
                    });
            //Creating dialog box
        ...
        new PS_PDF1.RetrievePDFStream().execute(link);
    }
    ...
    class RetrievePDFStream extends AsyncTask<String, Void, InputStream> {
        ...
        {
            progressDialog = new ProgressDialog(PS_PDF1.this);
