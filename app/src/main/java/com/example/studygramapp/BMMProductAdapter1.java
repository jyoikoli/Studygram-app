...
public class BMMProductAdapter1 extends RecyclerView.Adapter<BMMProductAdapter1.ProductViewHolder> {
    ...
    // Constructor
    public BMMProductAdapter1(Context context, List<Product1> productList, OnItemClickListener listener) {
