...
public class View_Events extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notesReference = database.getReference().child("notes");
                    ...
                    if (title.isEmpty()) {
                        ...
                        notesReference.push().setValue(newNote)
                                .addOnSuccessListener(aVoid -> {
                                    Toast.makeText(View_Events.this, "Note added successfully", Toast.LENGTH_SHORT).show();
                                    dialogInterface.dismiss();
                                })
                                .addOnFailureListener(e -> {
                                    Toast.makeText(View_Events.this, "Error adding note", Toast.LENGTH_SHORT).show();
                                    dialogInterface.dismiss();
                                });
                    }
                })
        ...
        AlertDialog alertDialog = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Save", (dialogInterface, i) -> {
                    ...
                    if (newTitle.isEmpty()) {
                        ...
                        notesReference.child(note.getKey()).setValue(updatedNote)
                                .addOnSuccessListener(aVoid -> {
                                    Toast.makeText(View_Events.this, "Note edited successfully", Toast.LENGTH_SHORT).show();
                                    dialogInterface.dismiss();
                                })
                                .addOnFailureListener(e -> {
                                    Toast.makeText(View_Events.this, "Error editing note", Toast.LENGTH_SHORT).show();
                                    dialogInterface.dismiss();
                                });
                    }
                })
                ...
                .setNegativeButton("Delete", (dialogInterface, i) -> {
                    ...
                    notesReference.child(note.getKey()).removeValue()
                            .addOnSuccessListener(aVoid -> {
                                Toast.makeText(View_Events.this, "Note deleted successfully", Toast.LENGTH_SHORT).show();
                                dialogInterface.dismiss();
                            })
                            .addOnFailureListener(e -> {
                                Toast.makeText(View_Events.this, "Error deleting note", Toast.LENGTH_SHORT).show();
                                dialogInterface.dismiss();
                            });
                })
                .create();
