...
public class PSProductAdapter1 extends RecyclerView.Adapter<PSProductAdapter1.ProductViewHolder> {
    ...
    // Constructor
    public PSProductAdapter1(Context context, List<Product1> productList, OnItemClickListener listener) {
