...
public class MProductAdapter1 extends RecyclerView.Adapter<MProductAdapter1.ProductViewHolder> {
    ...
    // Constructor
    public MProductAdapter1(Context context, List<Product1> productList, OnItemClickListener listener) {
