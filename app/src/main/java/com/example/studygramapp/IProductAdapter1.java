...
public class IProductAdapter1 extends RecyclerView.Adapter<IProductAdapter1.ProductViewHolder> {
    ...
    // Constructor
    public IProductAdapter1(Context context, List<Product1> productList, OnItemClickListener listener) {
