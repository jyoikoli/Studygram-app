...
public class CProductAdapter1 extends RecyclerView.Adapter<CProductAdapter1.ProductViewHolder> {
    ...
    // Constructor
    public CProductAdapter1(Context context, List<CProduct1> productList, OnItemClickListener listener) {
