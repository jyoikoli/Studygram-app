...
public class PhiloProductAdapter1 extends RecyclerView.Adapter<PhiloProductAdapter1.ProductViewHolder> {
    ...
    // Constructor
    public PhiloProductAdapter1(Context context, List<Product1> productList, OnItemClickListener listener) {
