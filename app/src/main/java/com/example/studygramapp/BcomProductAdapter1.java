...
public class BcomProductAdapter1 extends RecyclerView.Adapter<BcomProductAdapter1.ProductViewHolder> {
    ...
    // Constructor
    public BcomProductAdapter1(Context context, List<Product1> productList, OnItemClickListener listener) {
