...
public class PhyscoProductAdapter1 extends RecyclerView.Adapter<PhyscoProductAdapter1.ProductViewHolder> {
    ...
    // Constructor
    public PhyscoProductAdapter1(Context context, List<Product1> productList, OnItemClickListener listener) {
