...
public class BBAProductAdapter1 extends RecyclerView.Adapter<BBAProductAdapter1.ProductViewHolder> {
    ...
    // Constructor
    public BBAProductAdapter1(Context context, List<Product1> productList, OnItemClickListener listener) {
