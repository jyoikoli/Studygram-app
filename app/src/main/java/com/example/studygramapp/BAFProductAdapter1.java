...
public class BAFProductAdapter1 extends RecyclerView.Adapter<BAFProductAdapter1.ProductViewHolder> {
    ...
    // Constructor
    public BAFProductAdapter1(Context context, List<Product1> productList, OnItemClickListener listener) {
